...
function newGame() {
	...
	removeClass(document.getElementById("img_karakter"), 'player_menang');
	removeClass(document.getElementById("img_karakter"), 'robot_menang');
	...
	b.state.forEach(function (cell, index) {
		html_cells[index].addEventListener('click', function () {
			...
			if (b.isTerminal()) {
				...
				if (winner !== 'draw') addClass(document.getElementById("img_karakter"), 'player_menang');
			...
			p.getBestMove(b, !maximizing, function (best) {
				...
				if (b.isTerminal()) {
					...
					if (_winner !== 'draw') addClass(document.getElementById("img_karakter"), 'robot_menang');
					drawWinningLine(b.isTerminal());
				}
				player_turn = 1; //Switch turns
			});
...
document.addEventListener("DOMContentLoaded", function (event) {
	...
	document.getElementById("pilih_mode").addEventListener('change', function (e) {
		if (e.target.value == "humanVShuman") {
